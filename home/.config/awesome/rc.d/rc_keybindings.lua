...
--    awful.key({ modkey, "Shift"   }, "i",  function () awful.spawn(chat_cmd) end,
--              {description="irssi", group="MY: apps"}),
    ...
    awful.key({ modkey, "Shift"   }, "a",  function () awful.spawn(mixer_cmd) end,
              {description="Alsa mixer", group="MY: system"}),

    awful.key({ modkey, "Shift"   }, "l",  function () awful.spawn(scripts_dir .. "start-locker.sh") end,
              {description="Lock screen", group="MY: system"}),
    ...
    awful.key({ }, "Print",  function () awful.spawn(scripts_dir .. "print-screen.sh") end,
              {description="Print screen", group="MY: system"}),
    awful.key({ modkey, "Shift"   }, "w",  function () awful.spawn(wallpaper_change_cmd) end,
              {description="Wallpaper change", group="MY: system"}),

    awful.key({ }, "XF86MonBrightnessDown",  function () awful.spawn(scripts_dir .. "brightness-dec.sh") end,
              {description="Dec brightness", group="MY: system"}),
    awful.key({ }, "XF86MonBrightnessUp",  function () awful.spawn(scripts_dir .. "brightness-inc.sh") end,
              {description="Inc brightness", group="MY: system"}),
    ...
    awful.key({ }, "XF86Display",  function () awful.spawn(video_mgr_cmd) end,
              {description="arandr", group="MY: system"}),
